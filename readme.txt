...
Download link:	https://github.com/azurecurve/azrcrv-url-shortener/releases/download/v1.2.0/azrcrv-url-shortener.zip
...
### [Version 1.2.1](https://github.com/azurecurve/azrcrv-url-shortener/tree/v1.2.1)
 * Fix bug with incorrect language load text domain.

### [Version 1.2.0](https://github.com/azurecurve/azrcrv-url-shortener/tree/v1.2.0)
...
### [Version 1.1.0](https://github.com/azurecurve/azrcrv-url-shortener/tree/v1.1.0)
 * Update azurecurve menu for better loading of plugins.
 * Fix bug with lookup of short url.

### [Version 1.0.1](https://github.com/azurecurve/azrcrv-url-shortener/tree/v1.0.1)
 * Update azurecurve menu for easier maintenance.
 * Move require of azurecurve menu below security check.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-url-shortener/tree/v1.0.0)
