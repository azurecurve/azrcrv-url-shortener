 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_urls')){
	function azrcrv_create_plugin_menu_urls(){
		azrcrv_create_plugin_menu_table_urls();
		azrcrv_populate_plugin_menu_table_urls();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_urls')){
	function azrcrv_populate_plugin_menu_table_urls(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_urls')){
	function azrcrv_create_plugin_menu_table_urls(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
